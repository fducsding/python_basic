...
def zhihuLogin():
    ...
    sess= requests.Session()    #类似于cookiejar的方法，但是比他更简单
    ...
    #用urllib.request的方法是没法获得cookie的值，所以需要获取
    #cookie的值时，可以使用requests库的方法来获取cookie的值

    #首先获取登录页面，找到需要的post的数据，同时会记录当前网页的cookie值
